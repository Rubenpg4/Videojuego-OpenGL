...
protected:
	...
	double ang_rot_x = 0; //angulo de rotación en el eje x
	double ang_rot_y = 0; //angulo de rotación en el eje y
	double ang_rot_z = 0; //angulo de rotación en el eje z
...
public:
	...
	void añadirEnemigo(int nivel, tipoEnemigo _tipo, float _x, float _y, float _z);
	
	void añadirEstructura(int nivel, tipoEstructura _tipo, int nTerreno);
